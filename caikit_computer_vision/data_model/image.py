...
from caikit_computer_vision.data_model.backends import PilImageBackend
...
class Image(DataObjectBase):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._backend = PilImageBackend(*args, **kwargs)
    ...
    def _check_initialization(self):
        ...
        """
        if not isinstance(getattr(self, "_backend", None), PilImageBackend):
            error(
                "<CCV14411171E>",
                AttributeError(
